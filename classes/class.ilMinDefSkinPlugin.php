<?php
/**
 * Class ilMinDefSkinPlugin
 * @author  Kalamun <rp@kalamun.net>
 * @version $Id$
 */

 class ilMinDefSkinPlugin extends ilUserInterfaceHookPlugin
 {
    const CTYPE = "Services";
    const CNAME = "UIComponent";
    const SLOT_ID = "uihk";
    const PLUGIN_NAME = "MinDefSkin";
 ...
 */    }
    ...
    public static function getInstance() : ilMinDefSkinPlugin
    {
